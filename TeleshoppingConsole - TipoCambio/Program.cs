       ...
       private static readonly string minutes = ConfigurationManager.AppSettings["Minutes"];
        ...
        static void Main(string[] args)
        {
            Log.Logger = new LoggerConfiguration()
                ...
                .WriteTo
                .File(
                    $@"{dirLogs}\TeleshoppingConsoleTipoCambio-.log",
            ...
            try
            {
                ...
                double tazaActual = traerTazaActual.ObtenerLaTazaActualDeDolaresXPesos();
                Console.WriteLine(tazaActual);
               // Console.WriteLine("Fin de Consumo Ws Taza Cambio");
                IEnviarTipoDeCambio enviartipodecambio = new BaseDeDatos();
                string resultado = enviartipodecambio.GuardarTipoDeCambio(tazaActual);
